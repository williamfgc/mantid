...
public:
  void test_simple_file() {
    //std::string filename("/SNS/ARCS/IPTS-24207/shared/3y9/MDE/mag005_Ei50meV_new.nxs");
    //std::string filename("/SNS/ARCS/IPTS-24207/shared/3y9/MDE/SrMnSb2_T2K_H0T_Ei50meV_dmb.nxs");
